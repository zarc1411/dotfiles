 ...
 */
static char *font = "Iosevka:style=Medium:pixelsize=18:antialias=true:autohint=true";
static char *font2[] = { "Iosevka:style=Medium:pixelsize=18:antialias=true:autohint=true" };
